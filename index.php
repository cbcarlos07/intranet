...
<div class="container-fluid"  >
	 ...
	 <div class="row cont" >
		...
		<div class="span3 quadro">
                    <a href="links/mv">
                    <div class="imagem">
                            <img src="img/MVG.png" class="img_quadro">
                    </div>
        ...
        <a href="links/mvpep">
         ...
         <a href="http://10.51.19.226/SE/index/painelv3.html">	
         <div class="span3 quadro">
        	<div class="imagem">
    ...
    <div class="row cont" align="center">
        ...
        <div class="span3 quadro">
                    <a href="http://soulmvlinks/ramais">
                    <div class="imagem">
                        <img src="img/lista.png" class="img_quadro" style="margin:19px 0px 0px 10px;">
                    </div>
            	
                    <div class="conteudo">

                        <font face="Arial" style="margin:-20px 0px 0px 25px;">RAMAIS</font>
                        <p>Lista de Ramais</p>
                        <!--<p style="margin-top:10px" class="fonte">SOULMV</p>-->
                    </div>
                          </a>
	       ...
	       <a href="links/microdata">
				<div class="span3 quadro">
					<div class="imagem">
						<img src="img/microdata.png" class="img_quadro" style="width:76%;margin-top: 40px;">
					</div>
					<div class="conteudo">
						<font face="Arial" style="margin:-20px 0px 0px 0px;">MICRODATA</font>
						<p>Diagnóstico por Imagem</p>
					</div>
				</div>
            </a>
			
			 <a href="links/mconnect">
				<div class="span3 quadro">
					<div class="imagem">
						<img src="img/mconnect.png" class="img_quadro" style="width:76%;margin-top: 50px;">
					</div>
					<div class="conteudo">
						<font face="Arial" style="margin:-20px 0px 0px 0px;">MCONNECT</font>
						<p>Visualizador de Imagem</p>
					</div>
				</div>
            </a>
		...
		<div class="span3 quadro">
                    <div class="imagem">
                        <img src="img/card.png" class="img_quadro" style="width:60%;margin-top:7px;margin-left:5px">
                    </div>
                    <div class="conteudo">
                        <font face="Arial" style="margin:-20px 0px 0px 10px;">NUTRI&Ccedil;&Atilde;O</font>
                        <p>Consulta de Card&aacute;pio</p>
                    </div>
		</div>
        </a>
    ...
    <div class="row cont" align="center">
          ...
          <a href="http://tickets.onixinterativa.com.br/">
                    <div class="span3 quadro">
                            <div class="imagem">
	...
	<a href="http://www.orizonbrasil.com.br">
       ...
       <a href="http://www.sulamerica.com.br">
				<div class="span3 quadro">
					<div class="imagem">
