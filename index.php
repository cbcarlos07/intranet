...
<div class="principal">
    ...
    <div class="row cont" align="center">
	       <a href="links/microdata">
				<div class="span3 quadro">
					<div class="imagem">
						<img src="img/microdata.png" class="img_quadro" style="width:76%;margin-top: 50px;">
					</div>
					<div class="conteudo">
						<font face="Arial" style="margin:-5px 0px 0px 0px;">MICRODATA</font>
			 ...
			 <a href="links/mconnect">
				<div class="span3 quadro">
					...
					<div class="conteudo">
						<font face="Arial" style="margin:-5px 0px 0px 0px;">MCONNECT</font>
